...
minVal = -0.5; % y axis min
maxVal = 1.4; % y axis max

%% f0bk_faces
faces_LH = mean(f0bk_faces(1:180,:),2) / avg_f0bk_faces_baseline * 100; % percentage
...
y_star = repmat(-0.45,length(x_star),1); % the min value for the plot is -0.6
