% This code is written by Ruohan Zhang on 1 Mar 2025 for the
...
load(fullfile(savefolder,'ttest_HCP_Rest3T_FC_lateralization.mat'));

fig_savefolder1 = fullfile(savefolder,'fig','HCP_Rest3T_FC_lateralization_Visual','Bon');
if ~exist(fig_savefolder1,'dir')
    mkdir(fig_savefolder1);
end
fig_savefolder2 = fullfile(savefolder,'fig','HCP_Rest3T_FC_lateralization_Visual','FDR');
...
MasterInd = [1:26 40 46 47 62:66 84:95 106:113]; % [80:87 14:17 127 131 128:130 132];
